...
module Mapper.Database (dbconn, describe, rawconn) where
...
rawconn = connectODBC "DRIVER={MySQL ODBC 5.2 Driver}; server=localhost; database=prinh_haskell; uid=paxer_brancher; password=@!?BV0ai$?#(" 